...
class install_sample_schema extends \phpbb\db\migration\migration
{
	...
	{
		return $this->db_tools->sql_column_exists($this->table_prefix . 'users', 'user_tsn');
	}
	...
	public function update_schema()
	{
		return array(
			'add_tables'		=> array(
				$this->table_prefix . 'tsn_tsn_table'	=> array(
					'COLUMNS'		=> array(
						'tsn_id'			=> array('UINT', null, 'auto_increment'),
						'tsn_name'			=> array('VCHAR:255', ''),
					),
					'PRIMARY_KEY'	=> 'tsn_id',
				),
			),
	...
	public function revert_schema()
	{
		return array(
			...
			'drop_tables'		=> array(
				$this->table_prefix . 'tsn_tsn_table',
			),
		);
	}
}
