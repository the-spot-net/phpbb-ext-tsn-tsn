...
class ucp_controller
{
	...
	public function display_options()
	{
		...
		$data = array(
			'user_tsn' => $this->request->variable('user_tsn', $this->user->data['user_tsn']),
		);
		...
		if ($this->request->is_set_post('submit'))
		{
			...
			if (empty($errors))
			{
				...
				$message = $this->language->lang('UCP_TSN_SAVED') . '<br /><br />' . $this->language->lang('RETURN_UCP', '<a href="' . $this->u_action . '">', '</a>');
