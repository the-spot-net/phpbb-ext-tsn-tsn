...
/**
 * the-spot.net Notification class.
 */
class sample extends \phpbb\notification\type\base
{
	...
	{
		return 'tsn.tsn.notification.type.sample';
	}
	...
	{
		return $this->language->lang('TSN_TSN_NOTIFICATION');
	}
	...
	{
		return $this->helper->route('tsn_tsn_controller', $this->get_data('tsn_sample_name'));
	}
	...
	{
		$this->set_data('tsn_sample_name', $data['tsn_sample_name']);
